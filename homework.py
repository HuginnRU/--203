...
class SportsWalking(Training):
    ...
    CALORIES_SPEED_SHIFT_MULTIPLIER: float = 0.035
    SQUARING: int = 2
    KM_M: float = 0.278
    CONST_M: int = 100
    ...
    def __init__(self,
        ...
        self.height_cm = height / self.CONST_M
    ...
    def get_spent_calories(self) -> float:
        ...
        return ((self.CALORIES_SPEED_SHIFT_MULTIPLIER * self.weight_kg
                + (SPEED_IN_M ** self.SQUARING / self.height_cm)
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return ((self.get_mean_speed() + self.CALORIES_MULTIPLIER)
                * self.MULTIPLIER * self.weight_kg * self.duration_hour)
